package implementation_classes.Trees;
import java.util.Iterator;

import exceptions.*;
import implementation_classes.Lists.DoublyUnorderedLinkedList;
import implementation_classes.Queues.CircularArrayQueue;
...
public class ArrayBinaryTree<T> implements BinaryTreeADT<T> {
     ...
     * @param tempList The temporary list used in the traversal.
     */
    protected void levelOrder(int node, DoublyUnorderedLinkedList<T> tempList) throws ElementNotFoundException {
